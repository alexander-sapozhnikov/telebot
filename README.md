...
[![GoDoc](https://godoc.org/github.com/alexander-sapozhnikov/telebot?status.svg)](https://godoc.org/github.com/alexander-sapozhnikov/telebot)
...
```bash
go get -u github.com/alexander-sapozhnikov/telebot
```
...
[here](https://godoc.org/github.com/alexander-sapozhnikov/telebot#pkg-constants).
...
implementations:
```go
import "github.com/alexander-sapozhnikov/telebot/middleware"
```
...
[here](https://pkg.go.dev/github.com/alexander-sapozhnikov/telebot#Option).
