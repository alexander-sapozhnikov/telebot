...
[![GoDoc](https://godoc.org/github.com/alexander-sapozhnikov/telebot.v3?status.svg)](https://godoc.org/github.com/alexander-sapozhnikov/telebot.v3)
...
```bash
go get -u github.com/alexander-sapozhnikov/telebot.v3
```
...
[here](https://godoc.org/github.com/alexander-sapozhnikov/telebot.v3#pkg-constants).
...
implementations:
```go
import "github.com/alexander-sapozhnikov/telebot.v3/middleware"
```
...
[here](https://pkg.go.dev/github.com/alexander-sapozhnikov/telebot.v3#Option).
